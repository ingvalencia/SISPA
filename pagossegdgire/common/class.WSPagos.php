...
class WSPagos extends Abstracto
{
    ...
    public function __construct()
    {
        ...
        $this->arraymethod = [
            'fichadeposito.datos' => [
                'stage' => 'http://wscfdspruebas.patronato.unam.mx/wscfdspruebas/fichadepositoN3.php',
                'live' => '',
            ],
            'genera_cfdi.v1' => [
                'stage' => 'http://wscfdspruebas.patronato.unam.mx/wscfdspruebas/siiewebN.php',
                'live' => '',
            ],
            'inserttc.datos' => [
                'stage' => 'http://wscfdspruebas.patronato.unam.mx/wscfdspruebas/siiewebN.php',
            ...
            'consultabancoreferencia.srv' => [
                'stage' => 'http://132.248.40.26/wstiendapruebas/srv.php',
                'live' => '',
            ],
        ];
    }
    ...
    function createFichaDeposito($fecha, $convenio, $referencia, $concepto, $importe)
    {
        ...
        try {
			...
			$pdf->Output($path. "/fichas/doc/$referencia.pdf", 'F');
