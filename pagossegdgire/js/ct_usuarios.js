$(function() {
	...
	$("#btnSaveExcel").click(function(){
		...
		data = "opt=getExcel&nombre="+$("#snombre").val();
		data+= "&id_area="+$("#sid_area").val();
		
		$.download("./processUsuarios.php", data, "POST");
	});
	...
	$('#frmUsuario').formValidation({
		...
		if(!$("#passwd_ch").is(":checked")){
			dataSend.push({"name" : "passwd_ch", "value" : "off" });
		}
