...
if(!$usuarios){
	...
	$json["error"] = "si";
	$json["msg"] = "Error E001: No se pudo conectarse con el servidor, si el problema persiste comuniquese con el administrador";
...
if(!strcmp($opt,"getIni")){
	...
	if(!$resp){
		$json["error"] = "si";
		$json["msg"] = "Error E002: No se pudo conectarse con el servidor, si el problema persiste comuniquese con el administrador";
		$json["debug"] = $usuarios->getError();	
		die(json_encode($json));
	}
...
if(!strcmp($opt,"addUsuario")){
	...
	if(!$resp){
		$json["error"] = "si";
		$json["msg"] = "Error E003: No se pudo conectarse con el servidor, si el problema persiste comuniquese con el administrador";
		$json["debug"] = $usuarios->getError();	
		die(json_encode($json));
	}
...
if(!strcmp($opt,"updateUsuario")){
	...
	if(!$usuarios->updateUsuario($id_usuario, $dUsuario)){
		$json["error"] = "si";
		$json["msg"] = "Error E004: No se pudo conectarse con el servidor, si el problema persiste comuniquese con el administrador";
		$json["debug"] = $usuarios->getError();	
		die(json_encode($json));
	}
...
if(!strcmp($opt,"updatePassword")){
	...
	if(!$usuarios->updateUsuario($id_usuario, $dUsuario)){
		$json["error"] = "si";
		$json["msg"] = "Error E005: No se pudo conectarse con el servidor, si el problema persiste comuniquese con el administrador";
		$json["debug"] = $usuarios->getError();	
		die(json_encode($json));
	}
