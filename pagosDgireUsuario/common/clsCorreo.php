...
class clsCorreo extends clsConexion{
    ...
    public function enviaCorreoSolicitante($contenido, $datEmail,$referencia){
        ...
        /**/
            ...
            //$mail->addStringAttachment($doc, 'cedulaParticipante_'.$cveParticipante.'.pdf', 'base64', 'application/pdf');
    ...
    #******************************#
    public function enviaCorreoTicket($contenido, $datEmail,$num_folio_tic){
        ...
        /**/
            ...
            $mail->addAttachment( "../fichas/doc/".$num_folio_tic.'.pdf' );
    ...
    public function imprimeFormularioHtml($folio, $id_solicitante){
        ...
        <span class='m_1950253956932142205m_-1841532062777334958bkng-field' style='font-size:.8em;font-family:Helvetica Neue,Helvetica,Arial,sans-serif'>$folio</span>
        </td>
        </tr>
        <tr>
        ...
        <span class='m_1950253956932142205m_-1841532062777334958bkng-field' style='font-size:.8em;font-family:Helvetica Neue,Helvetica,Arial,sans-serif'>$row->fec_sol</span>
        </td>
        </tr>
        <tr>
        ...
        while($row1 = $resp1->fetch_object()){
			...
			"<tr>
				...
				$row1->nom_concepto_pago
				</td>
				<td align='center' class='m_1950253956932142205m_-1841532062777334958bkng-field' style='font-size:.8em;font-family:Helvetica Neue,Helvetica,Arial,sans-serif'>
				$row1->cant_requerida
				</td>
				<td align='center' class='m_1950253956932142205m_-1841532062777334958bkng-field' style='font-size:.8em;font-family:Helvetica Neue,Helvetica,Arial,sans-serif'>
				".number_format($row1->importe_concepto_pago,2)."
				</td>
				<td align='center'class='m_1950253956932142205m_-1841532062777334958bkng-field' style='font-size:.8em;font-family:Helvetica Neue,Helvetica,Arial,sans-serif'>
        ...
        <td style='color:#626262;font-size:1.2em;font-family:Helvetica Neue,Helvetica,Arial,sans-serif;margin:0;font-weight:bold'>$".number_format($row->monto_total,2)."</td>
        </tr>
        <tr>
        ...
        <tbody>
        <tr>
        <td><span style='color:#626262;font-size:0.7em;font-family:Helvetica Neue,Helvetica,Arial,sans-serif;margin:0;font-weight:normal'><br>
        </span></td>
        </tr>
        <tr>
        </tr>
