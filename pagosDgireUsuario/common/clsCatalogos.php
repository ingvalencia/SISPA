...
class clsCatalogos extends clsConexion{
	...
	public function getAreas(){
		...
		$query = " SELECT id_area, id_subdireccion, nom_area, vigente FROM ct_area ";
	...
	public function getColonia($id_cp){
		...
		FROM Mercurioz_dgirecat.ct_colonias c, Mercurioz_dgirecat.ct_ciudades city,
		Mercurioz_dgirecat.ct_municipios m, Mercurioz_dgirecat.ct_estados e
