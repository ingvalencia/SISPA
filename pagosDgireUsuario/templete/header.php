...
<!--#...**************************************************************************************************...#-->
    ...
    <!--- select2 
    <link rel="stylesheet" href="../bower_components/select2/select2.css"></link>
    <link rel="stylesheet" href="../bower_components/select2/select2-bootstrap.css"></link>
    -->
...
<!--<body class="hold-transition skin-blue layout-top-nav"  onload="setTimeout('dialog.alert(\'Su sesión expira en 30 segundos\')', 270000)"> -->
